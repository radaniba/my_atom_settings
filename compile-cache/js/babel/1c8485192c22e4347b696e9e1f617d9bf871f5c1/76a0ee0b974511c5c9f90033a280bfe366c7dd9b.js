...
var MinimapElement = (function () {
  ...
  _createClass(_MinimapElement, [{
    ...
    value: function measureHeightAndWidth(visibilityChanged) {
      var forceUpdate = arguments[1] === undefined ? true : arguments[1];
    ...
    value: function updateCanvasesSize() {
      var canvasWidth = arguments[0] === undefined ? this.getFrontCanvas().width : arguments[0];
